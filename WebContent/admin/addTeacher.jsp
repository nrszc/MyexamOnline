...
<div class="container">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <h1 class="page-header text-center"><font color="white">教师注册</font></h1>
<form class="form-horizontal" role="form" action="../ManagementTeacher?method=addTeacher" method="post">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name ="tid" placeholder="请输入账号">
    </div>
  </div>
  <div class="form-group">
    <label for="lastname" class="col-sm-2 control-label"><font color="white">姓名</font></label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name = "tname" placeholder="请输入姓名">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-3 col-sm-6">
      <button type="submit" class="btn btn-primary btn-lg btn-block"  onclick="myFunction()">注册</button>
    </div>
  </div>
</form>	
</div>
