...
<div class="container">
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">2333在线考试系统</a>
    </div>
     <div>
        <ul class="nav navbar-nav">
            <li><a href="LoginServlet?usertype=check"><span class="glyphicon glyphicon-user"></span> 我的主页</a></li>
        </ul>
    </div>
    <ul class="nav navbar-nav navbar-right">
      <li><a href="LoginServlet?usertype=check" target="view_window"><span class="glyphicon glyphicon-log-in"></span> 登录</a></li>
    </ul>
  </div>
</nav>
			<div class="jumbotron">
